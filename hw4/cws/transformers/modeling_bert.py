...
class BertForTokenFeature(BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.bert = BertModel(config)
    ...
    Examples::
        ...
        from transformers import BertTokenizer, BertForTokenFeature
        import torch

        tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
        model = BertForTokenFeature.from_pretrained('bert-base-uncased')
